...
hyperparameters = {
    'dataset': ['swissprot'],
    #'n_shot': [1, 5],
    'n_shot': [5, ], # conf/main.yaml, conf/method/leo.yaml
    'method.optimize_backbone': [False, True],
    'method.enable_finetuning_loop': [False, True],
    'method.pretrained_backbone_weights_path': [
        'pretrained_weights/swissprot_baseline_model.tar',
        'pretrained_weights/swissprot_baseline_pp_model.tar',
    ],
...
short_name_mapping = {
    ...
    ('method.pretrained_backbone_weights_path', 'pretrained_weights/swissprot_baseline_model.tar'): 'pretrained_with_baseline',
    ('method.pretrained_backbone_weights_path', 'pretrained_weights/swissprot_baseline_pp_model.tar'): 'pretrained_with_baseline_pp',
